...
var Texts = map[string]map[string]string{
	"ru": {
		...
		"account_added_not_private": "🧐 начал наблюдать за <u>%s</u>, но он и так открытый. Я точно должен за ним наблюдать? Если нет, удали его (/del) чтобы я не тратил на него свои силы",
