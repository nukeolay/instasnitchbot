...
var Texts = map[string]map[string]string{
	"ru": {
		...
		"button_accounts":           "/accounts   👥 Показать список аккаунтов",
		"button_delete":             "/del   🗑️ Перестать следить за аккаунтом",
	...
	"en": {
		...
		"button_accounts":           "/accounts   👥 Show accounts",
		"button_delete":             "/del   🗑️ Stop tracking account",
		"button_help":               "/help   🆘 Help",
	},
}
